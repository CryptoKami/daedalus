...
@set DEFAULT_DAEDALUS_BRANCH=cryptokami-sl-0.4

set DAEDALUS_BRANCH=%1
@if [%DAEDALUS_BRANCH%]==[] (set DAEDALUS_BRANCH=%DEFAULT_DAEDALUS_BRANCH%)
set GITHUB_USER=%2
@if [%GITHUB_USER%]==[] (set GITHUB_USER=CryptoKami)
...
@pushd daedalus
    ...
    @rem NOTE: we're setting the CRYPTOKAMI_BRANCH to DEFAULT_DAEDALUS_BRANCH:
