...
import themeCryptokamiPreview from '../../../assets/images/themes/cryptokami.png';
...
const messages = defineMessages({
  ...
  themeCryptokami: {
    id: 'settings.display.themeNames.cryptokami',
    defaultMessage: '!!!Cryptokami',
    description: 'Name of the "Cryptokami" theme on the display settings page.',
  },
  themeDarkBlue: {
...
export default class DisplaySettings extends Component<Props> {
  ...
  render() {
    ...
    const themeCryptokamiClasses = classnames([
      theme === THEMES.CRYPTOKAMI ? styles.active : styles.inactive,
      styles.themeImageWrapper,
    ]);
    ...
    return (
      <div className={styles.component}>
        ...
        <div className={styles.themesWrapper}>
          ...
          <button
            className={themeCryptokamiClasses}
            onClick={selectTheme.bind(this, { theme: THEMES.CRYPTOKAMI })}
          >
            <img src={themeCryptokamiPreview} role="presentation" />
            <span>{intl.formatMessage(messages.themeCryptokami)}</span>
          </button>
