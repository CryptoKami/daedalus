...
const messages = defineMessages({
  ...
  disclaimerText: {
    ...
    defaultMessage: '!!!ATTENTION: Redeeming on the Cryptokami Test-net will validate that your certificate or redemption key is correct and will allow you to redeem TEST-ADA for testing purposes only. KEEP your certificate or redemption key safe and secure. You will need to redeem again when Cryptokami SL launches the mainnet. TEST-ADA holds no value and cannot be exchanged.',
