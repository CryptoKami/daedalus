...
import cryptokamiIcon from '../../assets/images/cryptokami-logo.inline.svg';
...
const messages = defineMessages({
  ...
  aboutContentCryptokamiHeadline: {
    id: 'static.about.content.cryptokami.headline',
    defaultMessage: '!!!Cryptokami Team:',
    description: 'About page cryptokami team headline',
  },
  ...
  aboutContentCryptokamiMembers: {
    id: 'static.about.content.cryptokami.members',
    ...
    description: 'About page cryptokami team members',
  },
...
export default class About extends Component<any> {
  ...
  render() {
    ...
    const apiHeadline = environment.isAdaApi()
      ? intl.formatMessage(messages.aboutContentCryptokamiHeadline)
      : intl.formatMessage(messages.aboutContentMantisHeadline);

    const apiMembers = environment.isAdaApi()
      ? intl.formatMessage(messages.aboutContentCryptokamiMembers)
      : intl.formatMessage(messages.aboutContentMantisMembers);

    const apiIcon = environment.isAdaApi() ? cryptokamiIcon : mantisIcon;
      ...
      <div className={styles.container}>
        ...
        <div className={styles.footerWrapper}>
          ...
          <div className={styles.copyright}>
            ...
            <a href="https://github.com/CryptoKami/daedalus/blob/master/LICENSE">
